 ...
 * @author Anonymous
 */
public class DeleteConfirm extends javax.swing.JDialog {
    ...
    public DeleteConfirm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public DeleteConfirm(java.awt.Frame parent, boolean modal, int hostId) {
        super(parent, modal);
        initComponents();
        this.hostId = hostId;
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DeleteConfirm dialog = new DeleteConfirm(new javax.swing.JFrame(), true);
