 ...
 * DVFS, but no dynamic optimization of the VM allocation. The adjustment of the
 * hosts' power consumption according to their CPU utilization is happening in
 * the PowerDatacenter class.
 *
